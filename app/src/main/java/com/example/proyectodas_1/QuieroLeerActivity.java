...
public class QuieroLeerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lista_libros_preferidos);

        crearCanalNotificacion();

        RecyclerView recyclerView = findViewById(R.id.recyclerQuieroLeer);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        OperacionesBD db = new OperacionesBD(this, 1);
        String usuario = getIntent().getStringExtra("usuario"); // Recibimos el usuario
        ...
        listaLibros = db.listaQuieroLeer(usuario);
    ...
    private void descargarLibros() {
        ...
        String fileName = "quiero_leer.txt";
